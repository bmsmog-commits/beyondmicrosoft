...
export const AI_EVENTS = Object.freeze({
  ...
  BRIEF_OFFERED: 'ai_brief_offered',
  BRIEF_GENERATED: 'ai_brief_generated',
  BRIEF_EDITED: 'ai_brief_edited',
  BRIEF_ERROR: 'ai_brief_error',
  INQUIRY_STARTED: 'ai_inquiry_started',
  INQUIRY_SUBMITTED: 'ai_inquiry_submitted',
  INQUIRY_ERROR: 'ai_inquiry_error',
