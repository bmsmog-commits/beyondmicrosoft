...
export const projects = [
  {
    ...
    description: 'A web presence built around clarity, mission and trust for a mission-led organization.',
    status: 'Completed',
    featured: true,
    image: '/assets/design/bms-card-front.jpg',
  ...
  },
  {
    ...
    category: 'Web Development',
    description: 'A conversion-focused landing page concept demonstrating modern design and polished frontend execution.',
    status: 'Completed',
    featured: true,
    image: '/assets/projects/furniture-website-screenshot.png',
    technologies: ['Landing Page', 'Responsive Design', 'UX'],
    projectUrl: '',
  },
  {
    title: 'Automation Workflow',
    category: 'AI Automation',
    description: 'Workflow systems and process architecture designed to connect tools, reduce repetitive work and improve efficiency.',
    status: 'Completed',
    featured: true,
    image: '/assets/automation/customs-compliance-flow.png',
    technologies: ['n8n', 'Process Design', 'AI Workflow'],
    projectUrl: '',
  },
  {
    title: 'Brand Identity Project',
    category: 'Brand Design',
    description: 'Identity and brand communication work crafted to present a business as clear, credible and memorable.',
    status: 'Completed',
    featured: true,
    image: '/assets/design/bms-card-back.jpg',
    technologies: ['Brand Strategy', 'Visual Identity', 'Creative Direction'],
    projectUrl: '',
  },
  {
    title: 'Beyond Microsoft',
    category: 'Web Development',
    description: 'The BMS personal brand platform is in active development and will be published as the brand grows.',
    status: 'Coming Soon',
    featured: true,
    image: '/assets/design/STC.jpg',
  ...
  },
  {
    ...
    category: 'Application Development',
    description: 'A personal productivity app currently in development, designed for useful daily writing and structured thinking.',
    status: 'In Development',
    featured: true,
    image: '/assets/design/bms-card-front.jpg',
    technologies: ['Product Design', 'Application UX', 'Frontend Dev'],
    projectUrl: '',
  },
];
